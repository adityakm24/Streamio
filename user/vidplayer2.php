...
<body style="background: rgb(0,0,0);">
    <div class="container-fluid" id="dqv">
        ...
        <div>
            <h1 style="background: #000000;color: rgb(255,255,255);">The Tomorrow War - Final Trailer (2021)</h1>

            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/LnIbOiskSdc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width:70%; height:500px;"></iframe>

            <p>IMDB: 6.5/10<br>Rotten Tomatoes: 52%<br>Metacritic: 45%</p>
            <p>When a group of time travellers from the future tell people about a war they are fighting with aliens, Dan, a school teacher, decides to help them win it in order to secure his daughter's future.</p>
