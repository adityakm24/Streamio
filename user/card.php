...
<div class="payment-title">
    ...
    <form action="/user/payment/index.html" method="POST">
    <div class="form-container">
        ...
        <div class="field-container">
            ...
            <input id="expirationdate" type="date" pattern="[0-9]*" inputmode="numeric" required>
        </div>
        <div class="field-container">
        ...
        <div class="field-container">
            <a href="\payment\index.html"><button type="button" class="btn btn-primary" value="Primary">Pay<button></a>
</div>
    </div>
    </form>
...
var cardnumber_mask = new IMask(cardnumber, {
    ...
    dispatch: function (appended, dynamicMasked) {
        ...
        for (var i = 0; i <script dynamicMasked.compiledMasks.length; i++) {
