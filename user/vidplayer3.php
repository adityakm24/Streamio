...
<body style="background: rgb(0,0,0);">
    <div class="container-fluid" id="dqv">
        ...
        <div>
            <h1 style="background: #000000;color: rgb(255,255,255);">The Platform | Main Trailer | Netflix</h1>

            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/RlfooqeZcdY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width:70%; height:500px;"></iframe>

            <p>IMDB: 7/10<br>Rotten Tomatoes: 79%<br>Metacritic: 73%</p>
            <p>In the future, prisoners housed in vertical cells watch as inmates in the upper cells are fed while those below starve.</p>
